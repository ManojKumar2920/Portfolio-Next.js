    ...
    <div className=" w-[70%] sm:w-full">
      ...
      <div className=" flex flex-wrap md:flex-col sm:flex-col items-center gap-8 py-8 sm:justify-center">
        {ProjectContent.map((project, index) => (
          <Tilt
            key={index}
            className="  bg-white border-slate-200 rounded-lg shadow-sm w-[45%] md:w-full sm:w-full border dark:border-slate-800 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 odd:-rotate-1 even:rotate-1 hover:rotate-1 transition-transform duration-700 hover:duration-100 ease-in-out p-5"
          >
